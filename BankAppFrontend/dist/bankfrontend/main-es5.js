...
var AppComponent = /** @class */ (function () {
    function AppComponent(route) {
        ...
        this.route.events.subscribe(function (res) {
...
/* harmony import */ var _syncfusion_ej2_angular_popups__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @syncfusion/ej2-angular-popups */ "./node_modules/@syncfusion/ej2-angular-popups/@syncfusion/ej2-angular-popups.es5.js");
...
/* harmony import */ var _angular_material_menu__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! @angular/material/menu */ "./node_modules/@angular/material/esm5/menu.es5.js");
...
var EmailverificationComponent = /** @class */ (function () {
    function EmailverificationComponent(fb, router, authservice) {
        this.fb = fb;
        this.router = router;
    ...
    Object.defineProperty(EmailverificationComponent.prototype, "f", {
        get: function () { return this.verificationform.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(EmailverificationComponent.prototype, "emailf", {
        get: function () { return this.emailform.controls; },
        enumerable: true,
        configurable: true
    });
    EmailverificationComponent.prototype.checkotp = function () {
        var _this = this;
        debugger;
        ...
        if (this.verificationform.valid == true) {
            ...
            this.authservice.verifyOtp(this.formdata).subscribe(function (data) {
                debugger;
                if (data == 1) {
                    ...
                    _this.verificationform = _this.fb.group({
                        otp: ''
                    });
                }
                else {
    ...
    EmailverificationComponent.prototype.Continue = function () {
        var _this = this;
        debugger;
        this.submitted = true;
        if (this.emailform.valid == true) {
            this.formdata.Email = this.emailform.value.email;
            this.authservice.verifyEmail(this.formdata).subscribe(function (data) {
                debugger;
                if (data == 1) {
                    _this.router.navigate(['login']); //email verified
    ...
    EmailverificationComponent.prototype.resend = function () {
        this.authservice.resendOTP(this.formdata).subscribe(function (data) {
            if (data == 1) {
...
var ForgotpasswordComponent = /** @class */ (function () {
    function ForgotpasswordComponent(fb, router, authservice, toaster) {
        var _this = this;
        this.fb = fb;
        this.router = router;
        this.authservice = authservice;
        ...
        this.dlgButtonClick = function () {
            _this.modalDialog.hide();
            _this.initialize();
        };
    ...
    Object.defineProperty(ForgotpasswordComponent.prototype, "f", {
        get: function () { return this.emailverificationform.controls; },
        enumerable: true,
        configurable: true
    });
    ForgotpasswordComponent.prototype.showdata = function () {
        var _this = this;
        debugger;
        this.submitted = true;
        if (this.emailverificationform.valid == true) {
            this.formdata.Email = this.emailverificationform.value.email;
            this.authservice.sendemail(this.formdata).subscribe(function (data) {
                if (data == 'Success') {
                    debugger;
                    _this.istrue = false;
                    ...
                    _this.toaster.error("Email is invalid");
                }
            }, function (err) {
                console.log(err);
            });
    ...
    ForgotpasswordComponent.prototype.initialize = function () {
        this.emailverificationform = this.fb.group({
            email: ''
        });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, router, authservice, toaster) {
        this.fb = fb;
        this.router = router;
        this.authservice = authservice;
        this.toaster = toaster;
    ...
    LoginComponent.prototype.login = function () {
        ...
        if (this.loginform.valid) {
            ...
            this.authservice.login(this.formdata).subscribe(function (data) {
                debugger;
                _this.formdata = data;
                window.localStorage.setItem("accountid", _this.formdata.AccountId.toString());
                if (_this.formdata.Id == 1) { // verified + register
                    window.localStorage.setItem("authenticationToken", _this.formdata.JWT);
                ...
                else if (_this.formdata.Id == 2) { // register !verified
                    _this.router.navigate(['/verify']);
                    _this.toaster.success('you are not a verified user', 'please verify first');
                }
                else if (_this.formdata.Id == 0) {
                    _this.toaster.error("Not a registered user");
                    _this.router.navigate(['/register']); //not register
                }
                else {
                    _this.toaster.error('Email and pin is invalid', 'Enter valid email'); //incorrect password
                }
            }, function (err) {
                console.log(err);
            });
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.showdata = function () {
        var _this = this;
        this.submitted = true;
        // stop here if form is invalid
        if (this.registerForm.valid) {
            ...
            this.authservice.register(this.formdata).subscribe(function (data) {
                debugger;
                if (data == "Success") {
                    //  console.log(this.registerForm.value);
                    debugger;
...
var ResetpasswordComponent = /** @class */ (function () {
    function ResetpasswordComponent(fb, router, authservice, route, toaster) {
        this.fb = fb;
        this.router = router;
        this.authservice = authservice;
        this.route = route;
    ...
    ResetpasswordComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params != null) {
                _this.formdata.Guid = params['resetcode'];
            }
        });
    ...
    ResetpasswordComponent.prototype.resetpassword = function () {
        ...
        if (this.resetpasswordform.valid == true) {
            ...
            this.authservice.resetpass(this.formdata).subscribe(function (data) {
                _this.formdata = data;
                if (_this.formdata.Id == 1) {
                    _this.toaster.success("your password has successfully changed");
                    _this.router.navigate(['login']);
                }
                else if (_this.formdata.Id == -1) {
                    _this.toaster.error('Can not changed your password ,something went wrong', 'please verify your email again');
                }
                else {
...
var AddMoneyComponent = /** @class */ (function () {
    function AddMoneyComponent(fb, router, bankservice, toaster, logoutService) {
        this.fb = fb;
        this.router = router;
    ...
    AddMoneyComponent.prototype.ngOnInit = function () {
        ...
        this.bankservice.detail(this.formdata1.AccountId).subscribe(function (data) {
            if (data != null) {
    ...
    Object.defineProperty(AddMoneyComponent.prototype, "f", {
        get: function () { return this.addbalanceform.controls; },
        enumerable: true,
        configurable: true
    });
    AddMoneyComponent.prototype.Continue = function () {
        var _this = this;
        this.submitted = true;
        if (this.addbalanceform.valid == true) {
            ...
            this.bankservice.addMoney(this.formdata).subscribe(function (data) {
                if (data == 1) {
                    _this.toaster.success("Balance is added to your account");
                    _this.addbalanceform = _this.fb.group({
                        addbalance: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                        pin: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
                    });
                    _this.formdata1.AccountId = parseInt(localStorage.getItem("accountid"));
                    _this.bankservice.detail(_this.formdata1.AccountId).subscribe(function (data) {
                        if (data == 1) {
                            _this.formdata1 = data;
                        }
                    });
                    ...
                    _this.toaster.error("transaction has failed");
                }
                else {
                    _this.toaster.error(' check your PIN', 'invalid PIN');
                    _this.addbalanceform = _this.fb.group({
                        addbalance: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                        pin: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
                    });
    ...
    AddMoneyComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var ChangePasswordComponent = /** @class */ (function () {
    function ChangePasswordComponent(fb, router, bankservice, route, toaster) {
        this.fb = fb;
        this.router = router;
        this.bankservice = bankservice;
        this.route = route;
    ...
    ChangePasswordComponent.prototype.resetpassword = function () {
        ...
        if (this.changepasswordform.valid == true) {
            ...
            this.bankservice.changepass(this.formdata).subscribe(function (data) {
                _this.formdata = data;
                if (_this.formdata.Id >= 1) {
                    _this.toaster.success("your password has successfully changed");
                    _this.validation();
                ...
                _this.toaster.error("Please enter correct PIN", 'PIN is invalid');
                _this.validation();
            });
        }
...
var CheckBalanceComponent = /** @class */ (function () {
    function CheckBalanceComponent(router, bankservice, toaster, logoutService) {
        this.router = router;
        this.bankservice = bankservice;
        this.toaster = toaster;
        this.logoutService = logoutService;
    ...
    CheckBalanceComponent.prototype.ngOnInit = function () {
        ...
        this.bankservice.checkBalance(this.formdata.AccountId).subscribe(function (data) {
            if (data != null) {
                _this.formdata.Balance = parseInt(data.toString());
            }
            else {
                _this.toaster.error("no balance");
            }
        }, function (err) {
            if (err.status == 400) {
                _this.logoutService.logout();
    ...
    CheckBalanceComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var LinkAccountComponent = /** @class */ (function () {
    function LinkAccountComponent(fb, bankservice, router, toaster) {
        this.fb = fb;
        this.bankservice = bankservice;
        this.router = router;
        this.toaster = toaster;
    ...
    LinkAccountComponent.prototype.validation = function () {
        this.linkaccountform = this.fb.group({
            accountno: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            pin: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(4)]]
        });
    };
    Object.defineProperty(LinkAccountComponent.prototype, "f", {
        get: function () { return this.linkaccountform.controls; },
        enumerable: true,
        configurable: true
    });
    ;
    LinkAccountComponent.prototype.Continue = function () {
        var _this = this;
        debugger;
        this.submitted = true;
        if (this.linkaccountform.valid == true) {
            ...
            this.bankservice.linkaccount(this.formdata).subscribe(function (data) {
                _this.formdata = data;
                if (_this.formdata.Id == 1) {
                    _this.toaster.success('your account has linked Successfully ');
                    _this.router.navigate(['']);
                }
                else {
                    _this.toaster.error('Somthing went wrong');
                    _this.validation();
                }
            }, function (err) {
                console.log(err);
...
/* harmony import */ var src_app_services_banking_banking_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/banking/banking.service */ "./src/app/services/banking/banking.service.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var angular_user_idle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! angular-user-idle */ "./node_modules/angular-user-idle/fesm5/angular-user-idle.js");
/* harmony import */ var _services_logout_logout_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/logout/logout.service */ "./src/app/services/logout/logout.service.ts");
...
var PersonalDetailsComponent = /** @class */ (function () {
    //log1 : any;
    function PersonalDetailsComponent(router, bankservice, toaster, idleservice, logoutService) {
        this.router = router;
        this.bankservice = bankservice;
        this.toaster = toaster;
    ...
    PersonalDetailsComponent.prototype.ngOnInit = function () {
        ...
        //   })
        this.formdata.AccountId = parseInt(localStorage.getItem("accountid"));
        this.bankservice.detail(this.formdata.AccountId).subscribe(function (data) {
            debugger;
            if (data != null) {
                _this.formdata = data;
                // window.localStorage.setItem("personDetail",JSON.stringify(data));
                window.localStorage.setItem("accountno", _this.formdata[0].AccountNo + "");
            }
            else {
                _this.toaster.error("no details");
            }
        }, function (err) {
            if (err.status == 400) {
                _this.logoutService.logout();
...
var SendMoneyComponent = /** @class */ (function () {
    //log1:Logout
    function SendMoneyComponent(fb, router, bankservice, toster, logoutService) {
        this.fb = fb;
        this.router = router;
        this.bankservice = bankservice;
        this.toster = toster;
    ...
    SendMoneyComponent.prototype.validationcheck = function () {
        this.sendmoneyform = this.fb.group({
    ...
    Object.defineProperty(SendMoneyComponent.prototype, "f", {
        get: function () { return this.sendmoneyform.controls; },
        enumerable: true,
        configurable: true
    });
    SendMoneyComponent.prototype.Continue = function () {
        var _this = this;
        debugger;
        this.submitted = true;
        if (this.sendmoneyform.valid == true) {
            ...
            this.bankservice.sendMoney(this.formdata).subscribe(function (data) {
                if (data == 1) {
                    _this.toster.success('Thank you for using our service,for futher information go to transaction history.', ' your money has successfully transferred');
                    _this.router.navigate(['dashboard']);
                    _this.validationcheck();
                }
                else if (data == -1) {
                    _this.toster.error("money can't be sent successfully");
                    _this.validationcheck();
                }
                else if (data == -2) {
                    _this.toster.error("sender account not found");
                    _this.validationcheck();
                }
                else if (data == -3) {
                    _this.toster.error("Incorrect Pin");
                    _this.validationcheck();
                }
                else {
                    _this.toster.error("transaction has failed");
                    _this.validationcheck();
                }
            }, function (err) {
                if (err.status == 400) {
    ...
    SendMoneyComponent.prototype.verifyAccount = function (value) {
        var _this = this;
        debugger;
        if (value != null && value != undefined) {
            this.formdata.AccountNo = value;
            this.bankservice.verifyAccount(this.formdata).subscribe(function (data) {
                debugger;
                if (data == 1) { //account no.found or verified 
                }
                else if (data == -1) { //account no.found or not verified 
                    _this.toster.error("not a averified one");
                }
                else {
                    _this.toster.error("Account no.doesn't exist");
                    _this.validationcheck();
                }
            }, function (err) {
                console.log(err);
    ...
    SendMoneyComponent.prototype.verifyBalance = function (balance) {
        var _this = this;
        debugger;
        if (balance.toString() != "" && balance != undefined) {
            this.formdata.AddBalance = balance;
            this.bankservice.verifyBalance(this.formdata).subscribe(function (data) {
                debugger;
                if (data == 1) {
                }
                else {
                    _this.toster.error("Balance is not sufficient");
                    _this.validationcheck();
                }
            }, function (err) {
                console.log(err);
    ...
    SendMoneyComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: src_app_services_banking_banking_service__WEBPACK_IMPORTED_MODULE_4__["BankingService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"] },
...
var TransactionHistoryComponent = /** @class */ (function () {
    //log1=Logout;
    function TransactionHistoryComponent(route, bankservice, logoutService) {
        this.route = route;
        this.bankservice = bankservice;
        this.logoutService = logoutService;
        this.formdata = [];
    ...
    TransactionHistoryComponent.prototype.ngOnInit = function () {
        ...
        this.bankservice.transactionhistory(this.AccountId).subscribe(function (data) {
            if (data != null) {
                _this.formdata.push(data);
    ...
    TransactionHistoryComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: src_app_services_banking_banking_service__WEBPACK_IMPORTED_MODULE_3__["BankingService"] },
...
var UserorderComponent = /** @class */ (function () {
    function UserorderComponent(fb, router, bankservice, toster, routers) {
        this.fb = fb;
        this.router = router;
        this.bankservice = bankservice;
        this.toster = toster;
    ...
    UserorderComponent.prototype.ngOnInit = function () {
        var _this = this;
        debugger;
        this.routers.queryParams.subscribe(function (params) {
            if (params != undefined) {
                console.log(params);
                _this.formdata.Amount = parseInt(params['amount']);
                _this.formdata.OrderId = parseInt(params['orderid']);
    ...
    Object.defineProperty(UserorderComponent.prototype, "f", {
        get: function () { return this.userorderform.controls; },
        enumerable: true,
        configurable: true
    });
    UserorderComponent.prototype.verifyAccount = function (value) {
        var _this = this;
        debugger;
        if (value != null && value != undefined) {
            this.bankservice.verifyuseraccount(value).subscribe(function (data) {
                if (data == 'Success') {
                    _this.toster.success('OTP has sent to your email', 'please check your email for OTP');
                }
                else {
                    _this.toster.error('Account number does not exist', 'please enter a valid account number');
                }
            });
        }
    };
    UserorderComponent.prototype.continue = function () {
        var _this = this;
        this.submitted = true;
        if (this.userorderform.valid == true) {
            ...
            this.bankservice.userorder(this.formdata).subscribe(function (data) {
                if (data != null) {
                    _this.router.navigate(['']);
                }
            });
    ...
    UserorderComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: src_app_services_banking_banking_service__WEBPACK_IMPORTED_MODULE_4__["BankingService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"] },
...
var UserorderframeComponent = /** @class */ (function () {
    function UserorderframeComponent() {
    }
    UserorderframeComponent.prototype.ngOnInit = function () {
    };
    ...
    return UserorderframeComponent;
}());
...
var AnonymousGuard = /** @class */ (function () {
    function AnonymousGuard(router) {
        this.router = router;
    }
    ...
    AnonymousGuard.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(router, toaster) {
        this.router = router;
        this.toaster = toaster;
    }
    ...
    HeaderComponent.prototype.changepass = function () {
...
var LogoutService = /** @class */ (function () {
    function LogoutService(router, toaster) {
        this.router = router;
        this.toaster = toaster;
    }
